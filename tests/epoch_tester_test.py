...
class EpochTesterTestTest(unittest.TestCase):
    ...
    def test_single_fat(self):
        ...
        self.assertEqual(value.get('FAT timestamp'), 0.9)
    ...
    def test_single_4byte(self):
        ...
        value = self.tester.test(value_numeric)
        self.assertEqual(len(value),  1)
        self.assertEqual(value.get('4-Bytes bit-based timestamp since 1970'), 0.9)
    ...
    def test_single_5byte(self):
        ...
        value = self.tester.test(value_numeric)
        self.assertEqual(len(value),  1)
        self.assertEqual(value.get('5-Bytes bit-based timestamp'), 0.9)
    ...
    def test_multi(self):
        ...
        self.assertEqual(value.get('FAT timestamp'), 0.54)
        self.assertEqual(value.get('4-Bytes bit-based timestamp since 1970'), 0.18)
        self.assertEqual(value.get('5-Bytes bit-based timestamp'), 0.18)
